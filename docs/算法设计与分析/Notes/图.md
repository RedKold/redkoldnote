...
思考：对 [[vault/redkoldnote/docs/算法设计与分析/Notes/图#BFS|BFS]] 成立吗？（习题）[[未命名文件夹/redkoldnote/docs/算法设计与分析/作业/assignment4/23175036 朱晗 作业4#白路径定理对于 BFS 是否成立？请证明之或举反例|白路径定理在BFS是否成立]]
不成立。
